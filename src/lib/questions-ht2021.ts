...
export const subTests: SubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 34, text: 'Hur stor del av avfallet gick till <i>Energiåtervinning</i>?', options: ['1/2', '3/5', '3/4', '4/5'], correct: 0, diagram: '/prov-dtk1-diagram2.png', diagramAlt: 'Hushållsavfall', rotate: false, category: 'diagram' },
      ...
      { num: 37, text: 'Hur länge hade en flicka från yrkesskola 1966 varit omhändertagen?', options: ['1 år 10 mån', '2 år 5 mån', '2 år 7 mån', '2 år 9 mån'], correct: 3, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      ...
      { num: 39, text: 'Andel medier i Stockholm, Skåne och Västra Götaland?', options: ['50%', '55%', '60%', '65%'], correct: 2, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram' },

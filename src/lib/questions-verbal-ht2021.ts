...
export const verbalSubTests: VSubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 17, text: '<b>Vilket påstående överensstämmer bäst med hur texten beskriver barnlitteraturens nuvarande ställning?</b>', options: ['Barnlitteraturen är ännu i huvudsak ett nationellt fenomen.', 'Barnlitteraturen har fått en global giltighet genom en enhetlig uppfattning om vad som utgör en klassiker.', 'Barnlitteraturen har sedan länge haft erkännande som en egen och självständig litterär kategori.', 'Barnlitteraturen bedöms fortfarande normer som vuxit fram.'], correct: 0, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 18, text: '<b>Boken <i>Kinderliteratur</i> har den tyska barnlitteraturens relevans som utgångspunkt. Hur kommenterar bokens författare detta, enligt texten?</b>', options: ['Hon poängterar att utvecklingen i Tyskland typiskt speglar förhållanden i andra länder.', 'Hon hävdar att den tyska klassiska barnboken sedan länge har spridits till andra länder.', 'Hon konstaterar att Tysklands roll har förblivit central i den globala barnlitteraturen.', 'Hon menar att den tyska klassikern inte är oväsentlig men att övrig forskning behöver uppmärksammas särskilt.'], correct: 0, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 19, text: '<b>Vad sägs i texten om litterära verk som utmärks?</b>', options: ['De öppet riktade inte klassen vara som sig och som kan uppfattas som barnlitteratur eller vuxenlitteratur.', 'De hade goda förutsättningar att leva upp till de krav som Kümmerling-Meibauer ställer på en barnboksklassiker.', 'De är skrivna av utpräglade vuxenboksförfattare men kan läsas med uppskattning även av barn.', 'De är estetiskt sett lika värdefulla som vuxenlitteraturen, men saknar barnlitteraturens pedagogiska uppdrag.'], correct: 3, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 20, text: '<b>Vilka barnboksklassiker är det i första hand boken behandlar, enligt Bettina Kümmerling-Meibauer?</b>', options: ['De som är mest originella.', 'De som har fått internationell spridning.', 'De som har ett pedagogiskt upplägg.', 'De som har påverkat genrens utveckling.'], correct: 1, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
    ]
  },
  {

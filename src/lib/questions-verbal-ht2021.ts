...
export const verbalSubTests: VSubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 17, text: '<b>Vilket påstående överensstämmer bäst med hur texten beskriver barnlitteraturens nuvarande ställning?</b>', options: ['Barnlitteraturen är ännu i huvudsak ett nationellt fenomen.', 'Barnlitteraturen har fått en global giltighet som enskild uppfattning.', 'Barnlitteraturen har genomgått en genomgripande omvandling som innebördit att forskningens intresse har ökat.', 'Barnlitteraturen bedöms fortfarande normer som vuxit fram.'], correct: 0, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 18, text: '<b>Boken <i>Kinderliteratur</i> har den tyska barnlitteraturens relevans som utgångspunkt. Hur kommenterar författaren detta?</b>', options: ['Hon poängterar att utvecklingen i Tyskland typiskt speglar förhållanden i andra länder.', 'Hon hävdar att den tyska klassiska barnboken sedan länge har fått fotfäste utanför landets gränser.', 'Hon konstaterar att Tysklands roll har förblivit central i den globala barnlitteraturen.', 'Hon menar att syftet framför allt är att lyfta fram förbisedda aspekter.'], correct: 0, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 19, text: '<b>Vad sägs i texten om litterära verk som börjar bli ålderstigna?</b>', options: ['De är skrivna av utpräglade vuxenboksförfattare men kan läsa med uppskattas även av barn.', 'De har goda förutsättningar att leva upp till de krav som Kümmerling-Meibauer ställer på en klassiker.', 'De är estetiskt sett lika värdefulla som vuxenlitteraturen, men saknar barnlitteraturens pedagogiska uppdrag.', 'De hör inte alltid till de verk som man inte längre läser.'], correct: 3, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
      { num: 20, text: '<b>Vilka barnlitteratörer är det i första hand boken behandlar som klassiker, enligt Bettina Kümmerling-Meibauer?</b>', options: ['De som är mest originella.', 'De som har fått internationell spridning.', 'De som har bidragit med pedagogiska innovationer.', 'De som har påverkat genrens utveckling.'], correct: 1, images: ['/prov-las1-text3a.png', '/prov-las1-text3b.png'], textTitle: 'Text 3: Barnlitteratur' },
    ]
  },
  {

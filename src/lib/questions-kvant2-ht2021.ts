...
export const subTests: SubTest[] = [
  {
    ...
    questions: [
      ...
      { num: 5, text: '<b>Vilket är det ursprungliga priset på en vara om en rabatt på 8 procent gör varan 640 kronor billigare?</b>', options: ['5 120 kronor', '7 360 kronor', '7 680 kronor', '8 000 kronor'], correct: 3, category: 'procent', videoId: '1183889597' },
      { num: 6, text: 'Ida målar ett plank med konstant hastighet. Efter 4,5 timmar har hon målat 3/7 av planket. <b>Hur lång tid tar det för Ida att måla resten av planket?</b>', options: ['5 timmar', '5,5 timmar', '6 timmar', '6,5 timmar'], correct: 2, category: 'aritmetik', videoId: '1183981613' },
      { num: 7, text: `<div style="text-align:center;margin:0 0 1rem;"><img src="/prov-xyz2-q7.png" alt="Grafer f(x) och g(x)" data-fadein style="max-width:380px;" /></div>${tex('h(x) = f(x) + g(x)')}<br><br><b>Vilket svarsalternativ visar grafen till funktionen <i>h</i>, där <i>y</i> = <i>h</i>(<i>x</i>)?</b>`, options: ['<img src="/prov-xyz2-q7a.png" alt="A" style="max-width:140px;" />', '<img src="/prov-xyz2-q7b.png" alt="B" style="max-width:140px;" />', '<img src="/prov-xyz2-q7c.png" alt="C" style="max-width:140px;" />', '<img src="/prov-xyz2-q7d.png" alt="D" style="max-width:140px;" />'], correct: 3, category: 'funktioner', videoId: '1183889823' },
      ...
      { num: 9, text: '<b>Vilket svarsalternativ är med säkerhet lika med medelvärdet av de fem talen 14, 11, 13, <i>x</i> och 22?</b>', options: [tex('\\frac{15 + x}{2}'), tex('\\frac{60}{5} + x'), tex('60 + x'), tex('12 + \\frac{x}{5}')], correct: 3, category: 'aritmetik', videoId: '1183890024' },
      { num: 10, text: `<b>För vilket värde på <i>x</i> gäller att två tredjedelar av <i>x</i> är lika med</b> ${tex('\\frac{4}{7}')} ?`, options: [tex('x = \\frac{2}{3} \\cdot \\frac{4}{7}'), tex('x = \\frac{2}{3} \\cdot \\frac{7}{4}'), tex('x = \\frac{3}{2} \\cdot \\frac{4}{7}'), tex('x = \\frac{3}{2} \\cdot \\frac{7}{4}')], correct: 2, category: 'algebra', videoId: '1183890254' },
      { num: 11, text: `En cylinder har volymen 63 liter och diametern 4 dm. <b>Vilket svarsalternativ är närmast cylinderns höjd?</b>`, options: ['4 dm', '5 dm', '10 dm', '16 dm'], correct: 1, category: 'geometri', videoId: '1183890557' },
      { num: 12, text: `${tex('8 \\cdot 2^m = 4^0')}<br><br><b>Vad är <i>m</i>?</b>`, options: ['−3', '−2', '−1', '0'], correct: 0, category: 'algebra', videoId: '1183981772' },
    ]
  },
  {
    ...
    questions: [
      { num: 13, text: tex('3\\left(\\frac{2}{x} - \\frac{1}{6}\\right) = \\frac{3}{2}'), q1: '<i>x</i>', q2: tex('\\frac{1}{3}'), options: stdKvaOpts, correct: 0, category: 'algebra', videoId: '1183891008' },
      { num: 14, text: 'M är cirkelns medelpunkt.<div style="text-align:center;margin:1rem 0;"><img src="/prov-kva2-q14.png" alt="Cirkel med vinkel 250°" data-fadein style="max-width:300px;" /></div>', q1: '<i>v</i>', q2: '30°', options: stdKvaOpts, correct: 0, category: 'geometri', videoId: '1183891121' },
      { num: 15, text: 'En grupp med enbart kvinnor och män består av totalt 100 personer. Var och en av personerna är antingen högerhänt eller vänsterhänt. 75 % av kvinnorna är högerhänta. 12 kvinnor är vänsterhänta.', q1: 'Antalet kvinnor i gruppen', q2: 'Antalet män i gruppen', options: stdKvaOpts, correct: 1, category: 'procent', videoId: '1183891404' },
      { num: 16, text: '', q1: tex('\\sqrt{23}'), q2: tex('\\sqrt{9} + \\sqrt{5}'), options: stdKvaOpts, correct: 1, category: 'aritmetik', videoId: '1183891611' },
      { num: 17, text: `${tex('y > 0')}<br>${tex('\\frac{x}{y} = 5')}`, q1: '<i>y</i>', q2: '20 procent av <i>x</i>', options: stdKvaOpts, correct: 2, category: 'procent', videoId: '1183891756' },
      { num: 18, text: `Linjen L<sub>1</sub> har ekvationen ${tex('y = 3x - 1')}<br>Linjen L<sub>2</sub> har ekvationen ${tex('y = 5x + 3')}`, q1: 'x-koordinaten för skärningspunkten mellan L<sub>1</sub> och L<sub>2</sub>', q2: '0', options: stdKvaOpts, correct: 1, category: 'funktioner', videoId: '1183891902' },
      { num: 19, text: 'Linjerna L<sub>1</sub> och L<sub>2</sub> är parallella.<div style="text-align:center;margin:1rem 0;"><img src="/prov-kva2-q19.png" alt="Parallella linjer med trianglar" data-fadein style="max-width:340px;" /></div>', q1: 'Arean av triangeln ACE', q2: 'Arean av triangeln ABD', options: stdKvaOpts, correct: 3, category: 'geometri', videoId: '1183892098' },
      { num: 20, text: `<i>x</i> och <i>y</i> är två på varandra följande positiva heltal sådana att ${tex('y^2 - x^2 = 9')}.`, q1: '<i>y</i>', q2: '6', options: stdKvaOpts, correct: 1, category: 'algebra', videoId: '1183892338' },
      { num: 21, text: 'I Minnas smyckeskrin finns det halsband, armband och ringar. Armbanden är dubbelt så många som ringarna. Halsbanden är 3 fler än ringarna och 2 färre än armbanden.', q1: 'Antalet halsband i Minnas smyckeskrin', q2: '8', options: stdKvaOpts, correct: 2, category: 'algebra', videoId: '1183892559' },
      { num: 22, text: 'En mätserie består av tio mätvärden. Vart och ett av mätvärdena är ett heltal mellan 1 och 50. Mätseriens median är 25.', q1: 'Mätseriens median om det största mätvärdet tas bort', q2: '25', options: stdKvaOpts, correct: 3, category: 'aritmetik', videoId: '1183892737' },
    ]
  },
  {
    ...
    questions: [
      { num: 23, text: '<b>Vad är medelvärdet av <i>x</i>, <i>y</i>, <i>z</i> och <i>w</i>?</b>', s1: 'Medelvärdet av <i>x</i> och <i>z</i> är 83.', s2: 'Medelvärdet av <i>y</i> och <i>w</i> är 91.', options: stdNogOpts, correct: 2, category: 'logik', videoId: '1183893245' },
      { num: 24, text: 'Tre koppar, en vit, en svart och en röd, är staplade på varandra. <b>Vilken färg har den översta koppen?</b>', s1: 'Den röda koppen är längre ner än den svarta koppen. Den vita koppen är längre ner än den röda koppen.', s2: 'Den vita och den svarta koppen är längst ifrån varandra.', options: stdNogOpts, correct: 0, category: 'logik', videoId: '1183893523' },
      { num: 25, text: 'En eftermiddag samlar Robin och Anton grankottar och tallkottar. De hittar sammanlagt 83 kottar. <b>Hur många tallkottar hittar Robin?</b>', s1: 'Robin och Anton hittar sammanlagt 59 tallkottar.', s2: 'Robin hittar totalt 33 kottar.', options: stdNogOpts, correct: 4, category: 'logik', videoId: '1183893654' },
      { num: 26, text: 'Aron har fyra bollar: en vit, en gul, en röd och en svart. <b>Vilken av bollarna studsar bäst?</b>', s1: 'Den gula bollen studsar bättre än både den svarta och den vita. Den röda bollen studsar bättre än den vita.', s2: 'Den vita bollen studsar sämre än den svarta. Den svarta bollen studsar sämre än den gula. Den röda bollen studsar bättre än den gula.', options: stdNogOpts, correct: 1, category: 'logik', videoId: '1183894031' },
      { num: 27, text: `<i>n</i> är ett heltal. <b>Är <i>n</i> ett jämnt tal?</b>`, s1: `${tex('3n + 2')} är ett jämnt tal.`, s2: `${tex('n^2 + 3')} är ett udda tal.`, options: stdNogOpts, correct: 3, category: 'logik', videoId: '1183894336' },
      { num: 28, text: `I en burk ligger 10 enfärgade kulor: 3 röda och 7 gröna. Fler kulor, endast röda och gröna, läggs i burken så att förhållandet mellan röda och gröna kulor blir 1:2. <b>Hur många röda kulor läggs i burken?</b>`, s1: '5 kulor läggs i burken.', s2: `Antalet röda kulor som läggs i burken är ${tex('\\frac{2}{3}')} av antalet gröna kulor som läggs i burken.`, options: stdNogOpts, correct: 3, category: 'logik', videoId: '1183894741' },
    ]
  },
  {
    ...
    questions: [
      { num: 29, text: '<b>För hur många elever gällde att de fick betyget F i matematik eller att det saknades betygsunderlag i detta ämne?</b>', options: ['7 000', '8 000', '9 000', '10 000'], correct: 2, diagram: '/prov-dtk2-slutbetyg.png', diagramAlt: 'Slutbetyg i årskurs 9', rotate: false, category: 'tabell', videoId: '1183895232' },
      { num: 30, text: '<b>För vilket av de redovisade språken inom moderna språk (elevens val) var skillnaden mellan antalet flickor och antalet pojkar som minst?</b>', options: ['Tyska', 'Franska', 'Spanska', 'Övriga'], correct: 0, diagram: '/prov-dtk2-slutbetyg.png', diagramAlt: 'Slutbetyg i årskurs 9', rotate: false, category: 'tabell', videoId: '1183895420' },

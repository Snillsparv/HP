...
export const verbalSubTests: VSubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 16, text: '<b>Vilken av följande alternativa rubriker har mest med texten att göra?</b>', options: ['Effekterna av vårdreformer bland läkare.', 'Bristande kunskap om läkares arbetsförhållanden.', 'Läkare borde lära av andra yrkesgrupper.', 'Sjukfrånvaron förklarar läkares arbetssituation.'], correct: 0, images: ['/prov-las1-text2a.png', '/prov-las1-text2b.png'], textTitle: 'Text 2: Läkares hälsa' },
  ...
  },
  {
    ...
    questions: [
      { num: 21, text: 'Utfodring påverkar i regel inte älgarnas _____ att vandra till sina vinterhemområden. Men utfodringen kan styra dem inom de områden där de befinner sig, och därigenom minskas risken för trafikolyckor.', options: ['inriktning', 'benägenhet', 'åtagande', 'ansträngning'], correct: 2 },
      { num: 22, text: 'Efter att full betalning _____ och kommit oss _____ är du välkommen att hämta dina föremål hos oss på Auktionsverket.', options: ['erlagts – till handa', 'avsatts – till godo', 'bifogats – till rätta', 'utförts – till pass'], correct: 2 },
      { num: 23, text: 'Av 6 kap. 29 § högskoleförordningen _____ att det för varje doktorand ska upprättas en individuell studieplan. Denna ska innehålla högskolans respektive doktorandens _____ och därutöver en tidsplan för doktorandens utbildning. Studieplanen ska fastställas efter _____ med doktoranden och handledaren.', options: ['visas – underskrifter – samtal', 'uppges – godkännande – inrådan', 'säkerställs – inlägg – överläggningar', 'framgår – åtaganden – samråd'], correct: 4 },
      ...
      { num: 25, text: 'Dansare måste träna sig i kroppsmedvetenhet och i _____ för ordlös kommunikation. Det är färdigheter som är särskilt viktiga idag, då många tillbringar så mycket tid stillasittande och i virtuella verkligheter. Vår livsstil för oss allt längre bort från våra kroppsliga _____ och från att ta till oss andra ordlösa känslobudskap.', options: ['öppenhet – föraningar', 'lyhördhet – förnimmelser', 'synlighet – föreställningar', 'känslighet – företeelser'], correct: 2 },
      { num: 26, text: 'Senvuxen gran har täta årsringar och är rik på kåda, vilket ökar virkets hårdhet och gör det _____ mot fukt och röta.', options: ['skyddsvärt', 'förhärdat', 'tålmodigt', 'motståndskraftigt'], correct: 2 },
      { num: 27, text: 'I svensk debatt har förslag om medborgarlön med få undantag spelat en _____ roll och inte sällan _____ då det setts som något stolligt, verklighetsfrämande och arbetsfientligt.', options: ['befintlig – framhållits', 'reducerad – förnekats', 'ansenlig – formulerats', 'perifer – förlöjligats'], correct: 1 },
      { num: 28, text: 'Fyndet av människoben ger en sällsynt ögonblicksbild av komplexa _____ knutna till jägar- och samlarsamhället under äldre stenåldern, vilket _____ också låter oss få en inblick i den tidens _____.', options: ['skeenden – undermedvetet – kosthållning', 'mönster – oavsiktligt – ursprungsbefolkning', 'ritualer – indirekt – föreställningsvärld', 'relationer – omvänt – maktförhållanden'], correct: 0 },
      { num: 29, text: 'Kroppen har både ett yttre och ett inre infektionsförsvar. Till det yttre försvaret hör bland annat huden och slemhinnorna samt olika typer av _____, till exempel saliv, tårar, svett och magsaft.', options: ['plasma', 'serum', 'körtlar', 'sekret'], correct: 2 },

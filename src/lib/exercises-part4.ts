...
export const part4: Category[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: 'En linje lutar uppåt och stiger med 2 steg i y-led för varje steg i x-led. Om linjen skär y-axeln vid y = 1, vad är y när x = 3?', options: ['5', '7', '9', '6'], correct: 1, explanation: 'Lutningen k = 2 (stiger 2 per steg i x-led). m = 1 (skär y-axeln vid 1). Ekvationen: y = 2x + 1. Vid x = 3: y = 2 · 3 + 1 = 7.' },

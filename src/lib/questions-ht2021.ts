...
export const subTests: SubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 14, text: '', q1: tex('1 + \\frac{1}{4}'), q2: tex('\\frac{10}{8}'), options: stdKvaOpts, correct: 2, category: 'aritmetik' },
      ...
      { num: 20, text: '<i>F</i>(<i>n</i>) = summan av alla positiva heltal &lt; <i>n</i>.<br><i>G</i>(<i>n</i>) = summan av alla jämna positiva heltal &lt; <i>n</i>.', q1: '<i>F</i>(5)', q2: tex('\\frac{G(11)}{2}'), options: stdKvaOpts, correct: 1, category: 'aritmetik' },
      { num: 21, text: '', q1: 'Kvoten mellan en cirkels omkrets och dess diameter', q2: 'Kvoten mellan en kvadrats omkrets och dess sidlängd', options: stdKvaOpts, correct: 1, category: 'geometri' },
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 25, text: 'Anna och Berit springer den kortaste vägen från sina respektive hem till mötesplatsen C. De startar samtidigt, och var och en springer med sin egen konstanta hastighet. <b>Vem springer fortast?</b>', s1: 'Berit anländer till C före Anna.', s2: 'C ligger närmare Annas hem än Berits.', options: stdNogOpts, correct: 2, category: 'logik' },
      { num: 26, text: 'I en låda finns det enfärgade kulor: vita, svarta och gula. <b>Hur många svarta kulor finns det i lådan?</b>', s1: 'I lådan finns det 100 vita kulor, vilket är en tredjedel av det sammanlagda antalet svarta och gula kulor.', s2: 'I lådan finns det 100 gula kulor, vilket är hälften så många som antalet svarta kulor.', options: stdNogOpts, correct: 1, category: 'logik' },
  ...
  },
  {
    ...
    questions: [
      { num: 29, text: '<b>För vilket år gällde att antalet betalningsförelägganden var större än 40 000 och att andelen män bland gäldenärerna var större än 55 procent?</b>', options: ['2007', '2009', '2012', '2014'], correct: 3, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      { num: 30, text: '<b>Hur stor var den procentuella ökningen av antalet betalningsförelägganden 2014 jämfört med 2007?</b>', options: ['45 procent', '125 procent', '155 procent', '215 procent'], correct: 1, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      { num: 31, text: '<b>Hur många av betalningsföreläggandena 2013 avsåg kvinnor?</b>', options: ['19 676', '22 136', '24 596', '27 056'], correct: 1, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      ...
      { num: 34, text: '<b>Hur stor del av den totala mängden avfall gick till behandlingstypen <i>Energiåtervinning</i>?</b>', options: ['1/2', '3/5', '3/4', '4/5'], correct: 0, diagram: '/prov-dtk1-diagram2.png', diagramAlt: 'Hushållsavfall', rotate: false, category: 'diagram' },
      { num: 35, text: '<b>Hur stor andel av de omhändertagna eleverna 1967 var 15–16 år?</b>', options: ['1/6', '1/5', '1/4', '1/3'], correct: 2, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      { num: 36, text: 'Studera orsaker till omhändertaganden av flickor. <b>För vilken orsak hade andelen förändrats mest från 1965 till 1968, i procentenheter räknat?</b>', options: ['Biltillgrepp', 'Andra egendomsbrott', 'Sexuell vanart', 'Alkoholmissbruk'], correct: 2, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      { num: 37, text: '<b>Hur länge hade en flicka som skrevs ut från yrkesskola 1966 varit omhändertagen i genomsnitt?</b>', options: ['1 år och 10 månader', '2 år och 5 månader', '2 år och 7 månader', '2 år och 9 månader'], correct: 3, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      { num: 38, text: 'Andelen pojkar som omhändertogs på grund av misshandel minskade med 8,8 procentenheter från 1966 till 1968. <b>Hur många pojkar motsvarade denna minskning?</b>', options: ['30', '100', '180', '250'], correct: 1, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      { num: 39, text: '<b>Hur stor andel av det totala beståndet av medier fanns i storstadslänen Stockholm, Skåne och Västra Götaland?</b>', options: ['50 procent', '55 procent', '60 procent', '65 procent'], correct: 2, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram' },
      { num: 40, text: 'Jämför antalet medier på folkbibliotek i Jämtland och i Västerbotten. <b>Hur stor var skillnaden?</b>', options: ['545 000', '763 000', '925 000', '1 202 000'], correct: 0, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram' },
    ]
  }
];

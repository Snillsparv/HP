...
export const subTests: SubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 40, text: 'Jämför antalet medier på folkbibliotek i Jämtland och i Västerbotten. <b>Hur stor var skillnaden?</b>', options: ['545 000', '763 000', '925 000', '1 202 000'], correct: 0, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram', videoId: '1183052774' },
    ]
  }
];

...
export const verbalSubTests2: VSubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 14, text: '<b>Vad är enligt texten viktigt för att forskare ska trivas med ett högt tempo i arbetet?</b>', options: ['Att de själva har möjlighet att påverka situationen.', 'Att de får tid över till återkommande utvärderingar.', 'Att de upplever sitt arbete som personligt givande.', 'Att de uppfattar den direkta nyttan med sitt arbete.'], correct: 2, textTitle: 'Text 2: Långsammare (Jörn Hammarfelt)', images: ['/prov-las2-text2a.png', '/prov-las2-text2b.png'] },
      { num: 15, text: '<b>Vilken av följande personer tycks av texten att döma ha ett förslag som tydligt skiljer sig från de övrigas, när det gäller att hantera det höga tempot inom akademin?</b>', options: ['Filip Vostal.', 'Hartmut Rosa.', 'Donald Hall.', 'Maggie Berg.'], correct: 0, textTitle: 'Text 2: Långsammare (Jörn Hammarfelt)', images: ['/prov-las2-text2a.png', '/prov-las2-text2b.png'] },

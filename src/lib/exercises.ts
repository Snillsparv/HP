...
export const categories: Category[] = [
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: 'Talen är 1, 2, 3, 4, 100. Vad är medelvärdet?', options: ['3', '4', '22', '50'], correct: 2, explanation: 'Medelvärde = summa / antal = (1+2+3+4+100) / 5 = 110 / 5 = 22. Notera hur det extrema värdet 100 drar upp medelvärdet rejält — medianen är bara 3.' },

...
export const subTests: SubTest[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { num: 26, text: 'I en låda finns vita, svarta och gula kulor. <b>Hur många svarta kulor?</b>', s1: '100 vita kulor = en tredjedel av svarta + gula.', s2: '100 gula kulor = hälften så många som svarta.', options: stdNogOpts, correct: 1, category: 'logik' },
  ...
  },
  {
    ...
    questions: [
      { num: 29, text: 'Vilket år: betalningsförelägganden > 40 000 och andelen män > 55%?', options: ['2007', '2009', '2012', '2014'], correct: 3, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      { num: 30, text: 'Procentuell ökning av betalningsförelägganden 2014 jämfört med 2007?', options: ['45%', '125%', '155%', '215%'], correct: 1, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      { num: 31, text: 'Hur många betalningsförelägganden 2013 avsåg kvinnor?', options: ['19 676', '22 136', '24 596', '27 056'], correct: 3, diagram: '/prov-dtk1-diagram1.png', diagramAlt: 'Betalningsförelägganden', rotate: true, category: 'diagram' },
      { num: 32, text: 'Skillnaden mellan de två största behandlingstyperna?', options: ['1 130 000 ton', '1 222 000 ton', '1 352 000 ton', '1 444 000 ton'], correct: 0, diagram: '/prov-dtk1-diagram2.png', diagramAlt: 'Hushållsavfall', rotate: false, category: 'diagram' },
      ...
      { num: 36, text: 'Vilken orsak (flickor) förändrades mest 1965–1968 i procentenheter?', options: ['Biltillgrepp', 'Andra egendomsbrott', 'Sexuell vanart', 'Alkoholmissbruk'], correct: 0, diagram: '/prov-dtk1-diagram3.png', diagramAlt: 'Ungdomsvårdsskolor', rotate: true, category: 'tabell' },
      ...
      { num: 39, text: 'Andel medier i Stockholm, Skåne och Västra Götaland?', options: ['50%', '55%', '60%', '65%'], correct: 3, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram' },
      { num: 40, text: 'Skillnaden i medier: Jämtland vs Västerbotten?', options: ['545 000', '763 000', '925 000', '1 202 000'], correct: 0, diagram: '/prov-dtk1-diagram4.png', diagramAlt: 'Biblioteksbestånd', rotate: true, category: 'diagram' },
    ]
  }
];

...
export const categories: Category[] = [
  {
    ...
    exercises: [
      ...
      { q: `Vad är ${T('\\frac{2}{5} \\cdot \\frac{3}{4}')} ?`, options: [T('\\frac{6}{20}'), T('\\frac{5}{9}'), T('\\frac{3}{10}'), T('\\frac{6}{9}')], correct: 2, explanation: `Vid multiplikation av bråk multiplicerar vi täljare med täljare och nämnare med nämnare: ${T('\\frac{2 \\cdot 3}{5 \\cdot 4} = \\frac{6}{20}')}. Förenkla genom att dela båda med 2: ${T('\\frac{3}{10}')}.` },
      { q: `Vad är ${T('\\frac{3}{4} \\div \\frac{1}{2}')} ?`, options: [T('\\frac{3}{8}'), T('\\frac{3}{2}'), T('\\frac{6}{4}'), T('\\frac{1}{2}')], correct: 1, explanation: `Kom ihåg: division med ett bråk är samma sak som multiplikation med det omvända bråket. Vänd alltså ${T('\\frac{1}{2}')} till ${T('\\frac{2}{1}')} och multiplicera: ${T('\\frac{3}{4} \\cdot \\frac{2}{1} = \\frac{6}{4} = \\frac{3}{2}')}.` },
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: `Lös ${T('2x^2 = 50')}.`, options: ['x = 5', 'x = 25', 'x = ±5', 'x = 10'], correct: 2, explanation: `Steg 1: Dela med 2: ${T('x^2 = 25')}. Steg 2: Dra roten: ${T('x = \\pm 5')}. Kom ihåg att kvadratroten ger <b>två</b> lösningar, en positiv och en negativ!` },
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: 'I serien 3, 3, 5, 7, 7, 7, 9 är typvärdet:', options: ['3', '5', '7', '9'], correct: 2, explanation: 'Typvärdet är det tal som förekommer flest gånger. 7 förekommer 3 gånger, mer än något annat tal.' },
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: 'Kan en triangel ha sidorna 3, 4, 8?', options: ['Ja', 'Nej'], correct: 1, explanation: 'Triangelolikheten säger att summan av två sidor alltid måste vara större än den tredje sidan. 3 + 4 = 7 < 8, så det går inte att bilda en triangel.' },
      ...
      { q: 'En liksidig triangel har sidan 6. Vad är dess höjd?', options: [T('3\\sqrt{3}'), '3', T('6\\sqrt{3}'), '9'], correct: 0, explanation: `Höjden delar basen i två lika delar (3 var). Med Pythagoras: ${T('h^2 = 6^2 - 3^2 = 36 - 9 = 27')}, alltså ${T('h = \\sqrt{27} = 3\\sqrt{3}')}.` },
  ...
  },
  {
    ...
    exercises: [
      ...
      { q: `Vad är ${T('4^0')} ?`, options: ['0', '1', '4', 'Odefinierat'], correct: 1, explanation: `Allt (utom 0) upphöjt i 0 är alltid 1. ${T('4^0 = 1')}. Tänk: ${T('4^1 \\div 4^1 = 4^{1-1} = 4^0 = 1')}.` },
      { q: `Vad är ${T('2^{-3}')} ?`, options: ['−8', '−6', T('\\frac{1}{8}'), T('\\frac{1}{6}')], correct: 2, explanation: `Negativ exponent = ta inversen: ${T('2^{-3} = \\frac{1}{2^3} = \\frac{1}{8}')}. Negativt exponent betyder INTE negativt tal!` },
      ...
      { q: `Vad är ${T('\\sqrt{12} \\cdot \\sqrt{3}')} ?`, options: ['6', T('\\sqrt{15}'), T('3\\sqrt{4}'), T('\\sqrt{36}')], correct: 0, explanation: `${T('\\sqrt{12} \\cdot \\sqrt{3} = \\sqrt{12 \\cdot 3} = \\sqrt{36} = 6')}.` },
